...
<body>
    ...
    <div class="body">
        <hr>
        <div id="titleArea">
            <span id="titleText">비밀번호 찾기</span> <br>
        </div>
        ...
        <form method="POST" action="findPw" name="findPwForm" id="findPw" >
            <div class="wrap">
                ...
                <div>
                    ...
                    <span id="findIdText">아래 정보를 입력하시면 이메일로 비밀번호를 발송해드립니다. </span>
                </div>
                ...
                <div class="form-group">
                 	<div id="perviousBtn">
                        <button type="submit" class="btn btn-primary btn-lg" id="pervious"> 비밀번호 찾기 </button>
                    </div>
                </div>
            </div>
